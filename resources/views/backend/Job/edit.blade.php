    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 lg:col-span-6">
                <!-- BEGIN: Form Layout -->
                <form method="post" action="{{ route('jobs.update',$info->id) }}">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input id="exptitle" name="exptitle" type="text" class="form-control w-full"
                                           placeholder="Input text" required value="{{ $info->exptitle }}">
                                </div>
                                <div>
                                    <label for="crud-form-1" class="form-label"> Name</label>
                                    <input id="expmarketplace" name="expmarketplace" type="text"
                                           class="form-control w-full"
                                           placeholder="Input text" required value="{{ $info->expmarketplace }}">
                                </div>
                                <div>
                                    <label for="crud-form-1" class="form-label"> Name</label>
                                    <input id="expdescription" name="expdescription" type="text"
                                           class="form-control w-full"
                                           placeholder="Input text" required value="{{ $info->expdescription }}">
                                </div>
                                <div>
                                    <label for="crud-form-1" class="form-label"> Name</label>
                                    <input id="expsession" name="expsession" type="text" class="form-control w-full"
                                           placeholder="Input text" required value="{{ $info->expsession }}">
                                </div>
                            </div>
