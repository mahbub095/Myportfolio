                    ...
                    <div class="intro-y box p-5">
                        ...
                        <div>
                            <div>
                                ...
                                <textarea class="form-control" required name="name">{{ $info->name }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea class="form-control" required
                                          name="nationality">{{ $info->nationality }}</textarea>
                            </div>
                            ...
                            <label for="tag_line" class="form-label">Description</label>
                            <textarea class="form-control" required
