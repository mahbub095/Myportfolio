        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <table class="table table-report -mt-2">
                    ...
                    <tbody>
                    @foreach( $testimonials as $key => $tests)
                        <tr class="intro-x">
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{ $tests->name }}</a>
                            </td>
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{ $tests->desination }}</a>
                            </td>
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="{{--{{ route('testimonials.edit',$tests->id) }}--}}"> <i
                                            data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                    <a class="flex items-center text-danger" href="{{ route('testimonials.delete',$tests->id) }}" data-tw-toggle="modal"
