...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="{{ asset('demo/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('demo/css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('demo/css/font.css') }}">
